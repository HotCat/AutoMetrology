...
ZH_CN: dict[str, str] = {
    ...
    "Automatically switch backlight/ring light, capture fresh frames, and evaluate using fixed-scale registration": "自动切换背光/环形光，采集新图像，并使用固定比例配准计算",
    "Evaluate": "计算",
    "Export Results": "导出结果",
    "View Logs": "查看日志",
    ...
    "Dual-light orientation guard": "双光源方向保护",
    "Reject dual-light measurements when ring-light witnesses cannot disambiguate the 180-degree symmetric backlight window pose": "当环形光特征无法区分背光窗口的 180 度对称姿态时，拒绝双光源测量",
    "Line band:": "线条灰度带:",
    "+N band": "+N 灰度带",
    "-N band": "-N 灰度带",
    ...
    "Save As...": "另存为...",
    "Delete": "删除",
    "Saves fiducials, ROIs, and measurement options.": "保存基准点、ROI 和测量选项。",
    ...
    "Ring": "环形光",
    "Camera Role": "相机参数角色",
    "Camera settings are not available": "相机参数不可用",
    "Saved current camera settings as": "已保存当前相机参数为",
    "camera settings applied": "相机参数已应用",
    "camera settings apply error:": "相机参数应用错误:",
    "Camera role apply error:": "相机角色应用错误:",
    "Output:": "输出:",
    "Brightness:": "亮度:",
    "On": "开",
    "Off": "关",
    ...
    "test capture": "测试采集",
    "test capture undistorted": "测试采集（已校正）",
    "auto-light test capture complete": "自动光源测试采集完成",
    "auto-light test capture error:": "自动光源测试采集错误:",
